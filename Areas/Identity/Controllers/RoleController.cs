...
using WebAnToanVeSinhThucPhamDemo.Areas.Identity.Models.RoleViewModels;
...
namespace WebAnToanVeSinhThucPhamDemo.Areas.Identity.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, QlattpContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
