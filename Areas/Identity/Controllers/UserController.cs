...
using WebAnToanVeSinhThucPhamDemo.Areas.Identity.Models.UserViewModels;
...
namespace WebAnToanVeSinhThucPhamDemo.Areas.Identity.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, QlattpContext context, UserManager<AppUser> userManager)
        {
            _logger = logger;
